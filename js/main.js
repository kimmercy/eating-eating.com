...
// const cB = document.querySelector('#cart-icon')
// const cR = document.querySelector('.cart-remove')
// document.addEventListener("click", function (e) {
//     if (!cB.contains(e.target) && !cartBox.contains(e.target)) {
//         cartBox.classList.remove("active");
//     }
// })
// Cart working JS
...
function addCartClicked(event) {
    ...
    updatetotal();
    // awal pk console, cek di console trs baru pk add
}
